        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-5">
                <div class="card borde-0 shadow-lg">
                    ...
                    <form enctype="multipart/form-data" action="{{route('exams.update', $exam->id)}}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            <div class="mb-2">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Name" id="name" name="name" value="{{old('name', $exam->name)}}">
                                @error('name')
                                ...
                                <select class="form-select" aria-label="Default select example" name="category">
                                    ...
                                    @if ($categories->isNotEmpty())
                                        @foreach ($categories as $category)
                                            <option value="{{$category->name}}" @if (old('category', $exam->category) == $category->name) selected @endif>{{$category->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)"
                                    placeholder="0.00" name="price" step="0.01" value="{{old('price', $exam->price)}}">
                            </div>
                            @error('price')
                                <div class="alert alert-danger d-flex align-items-center" style="height: 16px" role="alert">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="container my-3">
                                    <label for="" class="h6">Image currently saved in DB:</label>
                                    <img src="{{asset($exam->image_path)}}" alt="" width="100" height="100">
                                </div>
                            ...
                            <div class="alert alert-warning" role="alert">
                                Only select and upload a new image if you want to update the current image.
                            </div>
